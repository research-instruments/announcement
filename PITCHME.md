...
#### [сообществу](https://research-instruments.github.io/network/) о любимых online-сервисах для исследователя

Поделись опытом использования наукометрических систем, соцсетей для ученых, свободнораспространяемых инструментов, и пр.
